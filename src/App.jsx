  ...
  const activateBtn = (element) => {
    ...
    if (element === 0) {
      btn.forEach((item, index) => {
        ((index === 1 || index === 2 || index === 3)) ? item.classList.remove('activate') : item.classList.add('activate');
      })
    }
    if (element === 1) {
      btn.forEach((item, index) => {
        ((index === 0 || index === 2 || index === 3)) ? item.classList.remove('activate') : item.classList.add('activate');
      })
    }
    if (element === 2) {
      btn.forEach((item, index) => {
        ((index === 1 || index === 0 || index === 3)) ? item.classList.remove('activate') : item.classList.add('activate');
      })
    }
    if (element === 3) {
      btn.forEach((item, index) => {
